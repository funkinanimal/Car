<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profiles.aspx.cs" Inherits="CarPark.profiles" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:autocon %>" ProviderName="<%$ ConnectionStrings:autocon.ProviderName %>" SelectCommand="SELECT * FROM &quot;PROFILES&quot;"></asp:SqlDataSource>
