<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cash.aspx.cs" Inherits="CarPark.cash" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <p>Здесь вы можете продать билет, выберите рейс, нажмите <strong>узнать дату</strong>, если хотите узнать дату рейса и затем нажмите <strong> продать</strong>.</p>
                </div>
                <div class="col-lg-4">
